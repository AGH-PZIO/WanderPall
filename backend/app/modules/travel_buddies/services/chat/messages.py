...
from app.modules.travel_buddies.repositories.protocols import MessageRepository
from app.modules.travel_buddies.schemas import CreateMessageRequest, MessageResponse, MessageListResponse, MessageDetailWithCountsResponse
