...
import { listExplorerFeed, upsertReaction, deleteReaction } from "../api/journal-api";
import { JournalCard } from "../components/JournalCard";

export function ExplorerFeedPage() {
  ...
  async function loadFeed(isLoadMore = false) {
    ...
    try {
      ...
      const result = await listExplorerFeed(accessToken, limit, currentOffset);
  ...
  return (
    <div className="jr-shell">
      <div className="jr-header">
        <div>
          <h2 style={{ margin: 0 }}>Explore Public Journals</h2>
          <p className="jr-muted" style={{ margin: "6px 0 0" }}>
            Discover travel journals from the community
          </p>
        </div>
        <div className="jr-actions">
          <button className="jr-btn-secondary jr-btn" type="button" onClick={() => navigate("/journal/explorer/my-public")}>
            My Public Journals
          </button>
      ...
      {loading && journals.length === 0 ? (
        ...
        <div className="jr-card">
          <p className="jr-muted">No public journals found. Be the first to share your travels!</p>
          <div className="jr-actions" style={{ justifyContent: "flex-start" }}>
